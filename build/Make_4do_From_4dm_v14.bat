...
if exist "C:\Program Files\12d\12dmodel\14.00\nt.x64\12d.exe" set where=C:\Program Files\12d\12dmodel\14.00\nt.x64
...
set "infofile=%repobin%\%fileBase%.txt"
echo { > "%infofile%"
echo "source": "%fullpath%" >> "%infofile%"
echo "compiler": "%QUOTED_CC4D_VERSION_DATA%" >> "%infofile%"
echo "command": "%mycmd%" >> "%infofile%"
echo } >> "%infofile%"
